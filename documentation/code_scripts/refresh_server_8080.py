...
Uses port 8080 as alternative if 8000 is blocked by firewall
"""
...
if __name__ == '__main__':
    PORT = 8080  # Using port 8080 as alternative
    
    print("=" * 60)
    print("L11 Networking Dashboard Server with Refresh API")
    print("=" * 60)
    print(f"Server directory: {BASE_DIR}")
    print(f"Dashboard URL: http://localhost:{PORT}/dashboard/simple_dashboard.html")
    print(f"Network URL: http://10.137.51.248:{PORT}/dashboard/simple_dashboard.html")
    print(f"Refresh API: http://localhost:{PORT}/api/refresh")
    print("=" * 60)
    print("IMPORTANT: If this port is also blocked, you need to:")
    print("1. Run PowerShell as Administrator")
    print("2. Run: netsh advfirewall firewall add rule name=\"L11 Dashboard\" dir=in action=allow protocol=TCP localport=8080")
    print("=" * 60)
