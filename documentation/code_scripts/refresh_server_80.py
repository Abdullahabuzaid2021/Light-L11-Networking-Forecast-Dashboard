...
if __name__ == '__main__':
    ...
    print(f"Dashboard URL: http://localhost/simple_dashboard.html")
    print(f"Network URL: http://10.137.51.248/simple_dashboard.html")
    print(f"Refresh API: http://localhost/api/refresh")
    print("=" * 60)
    print("NOTE: Port 80 might be blocked by another service")
    print("If port 80 is in use, try port 8080 or use GitHub Pages")
    print("=" * 60)
    ...
    try:
        ...
        print("2. Use GitHub Pages instead")
